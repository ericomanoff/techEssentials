...
?>
    ...
    <section id="services" class="text-center home-section">
      <div class="container">
        <div class="row">
           <h1 class="text-upper bottom40">Services</h1>
        </div>
        <div class="row">
          <div class="col-sm-4">
        ...
        <div class="row">
          <div class="col-sm-4">
            ...
            <p>Stay organized with ultra convenient Voice-to-Email service.</p>
          </div>
          <div class="col-sm-4">
            <i class="fa fa-database" aria-hidden="true"></i>
            <h3>Local IT Provider</h3>
            <p>Get up and running fast with a local partner and provider of IT solutions.</p>
          </div>
          <div class="col-sm-4">
  ...
  <section id="contact" class="text-center home-section">
    ...
    <div class="container">
      <a href="/contact" class="button quote">Get a Quote</a>
    </div>
